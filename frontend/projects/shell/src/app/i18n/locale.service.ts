 ...
 * so the Shell and the independently-built News remote — which each get
 * their own instance of this service — stay in sync without a shared
 * library (see Story 1 "no direct dependencies between microfrontends").
 */
